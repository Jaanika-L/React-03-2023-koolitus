...
const [kujundus, muudaKujundus] = useState(localStorage.getItem("veebilehe_kujundus"));
  ...
  const v2rvilineLeht = () =>{
    localStorage.getItem("veebilehe_kujundus", "colored_mode");
  ...
  return (
    <div>
      ...
      <button onClick={v2rvilineLeht}>Värviline leht</button>
      ...
      {localStorage.getItem("veebilehe_kujundus")=== "colored_mode" && <div>VÄRVILLINE LEHT</div>} */}
    </div>
